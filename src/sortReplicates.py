...
def analyze(asset1: str, asset2: str) -> None:
    ...
    for _, group in df_sorted.groupby('replicate_index'):
        ...
        # Collect change_pct values for overall median
    ...
    overall_median = np.median(bottom_change_pcts)
    print(f"median of all pooled 0–5th percentile change_pct values: {overall_median:.4f}")
